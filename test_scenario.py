...
commands = (f"MULTIPLY {OIL_CODE}:{OIL_GROUP} 2026Q3 1.10, 1.10, 1.10, 1.10\n"
            f"FIX {OIL_CODE}:{OIL_GROUP} 2026Q3:2027Q2")
...
def gdp(forecast_id, groups=("US", "CHINA", "EURO_11","INDONESI","MALAYSIA")):
...
for grp in ("US", "CHINA", "EURO_11","INDONESI","MALAYSIA"):
...
groups = ("US", "CHINA", "EURO_11","INDONESI","MALAYSIA","PHILIPPI","SINGPORE","THAILAND","VIETNAM")
colors = {"US": "tab:blue", "CHINA": "tab:red", "EURO_11": "tab:green","INDONESI": "tab:yellow","MALAYSIA": "tab:cyan"}
